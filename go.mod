...
require (
	...
	github.com/Hnampk/fabric-flogging v0.0.0-20201113090427-6106d8f9d1a9 // indirect
	github.com/Hnampk/fabric-usable-internal v0.0.0-20201106115033-4fb8fd2ef215 // indirect
