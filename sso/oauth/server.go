...
import (
	...
	"github.com/blcvn/lib-golang-test/lib/config"
	"github.com/blcvn/lib-golang-test/sso/oauth/mysqlstore"
...
func main() {
	db, err := Init()
	if err != nil {
		log.Println("Cannot connect mysql ")
		log.Fatalln(err)
	...
	manager.MustTokenStorage(mysqlstore.NewTokenStore(db))
	...
	clientStore, _ := mysqlstore.NewClientStore(db, mysqlstore.WithClientStoreTableName("custom_table_name"))

	ctx := context.Background()
	clientStore.Set(ctx, idvar, &models.Client{
		ID:     idvar,
		Secret: secretvar,
		Domain: domainvar,
	})
...
func loginHandler(w http.ResponseWriter, r *http.Request) {
	...
	outputHTML(w, r, "test/oauth/static/login.html")
}
...
func authHandler(w http.ResponseWriter, r *http.Request) {
	...
	outputHTML(w, r, "test/oauth/static/auth.html")
}
