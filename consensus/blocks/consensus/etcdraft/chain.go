...
import (
	...
	"github.com/blcvn/lib-golang-test/consensus/blocks/consensus/common/configtx"
	"github.com/blcvn/lib-golang-test/consensus/blocks/consensus/protoutil"

	// "github.com/blcvn/lib-golang-test/consensus/blocks/types"
	"github.com/blcvn/lib-golang-test/consensus/blocks/types/common"
	"github.com/blcvn/lib-golang-test/consensus/blocks/types/etcdraft"
...
func NewChain(
	...
	lg.Info("binhnt: support.Block: call")

	b := support.Block(support.Height() - 1)
	if b == nil {
		lg.Errorf("binhnt: failed to get last block")

		return nil, errors.Errorf("failed to get last block")
	}

	lg.Info("binhnt: create chain")
	...
	lg.Info("binhnt: set raft.Config")
	...
	lg.Info("binhnt.chain: create Node")
...
func (c *Chain) Order(env *common.Envelope, configSeq uint64) error {
	...
	c.logger.Infof("Chain.Order: Order request")
...
func (c *Chain) Configure(env *common.Envelope, configSeq uint64) error {
	...
	c.logger.Infof("Chain.Configure: Configure request")
...
func (c *Chain) Submit(req *orderer.SubmitRequest, sender uint64) error {
	c.logger.Infof("Chain.Submit: Receive Submit request from %d ", sender)
	if err := c.isRunning(); err != nil {
