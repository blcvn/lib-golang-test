...
import (
	...
	pborderer "github.com/blcvn/lib-golang-test/consensus/blocks/types/orderer"
...
func (stream *Stream) sendMessage(request *pborderer.StepRequest, report func(error)) {
	start := time.Now()
	var err error
	defer func() {
