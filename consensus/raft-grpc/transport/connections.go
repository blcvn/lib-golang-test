...
func (s *SDialer) Dial(address string, verifyFunc RemoteVerifier) (*grpc.ClientConn, error) {
...
func NewConnectionStore(
	dialer SecureDialer,
	// tlsConnectionCount metrics.Gauge,
) *ConnectionStore {
...
func (c *ConnectionStore) verifyHandshake(endpoint string, certificate []byte) RemoteVerifier {
	return func(rawCerts [][]byte, verifiedChains [][]*x509.Certificate) error {
		...
		// 	endpoint)
		return nil //binhnt: Not check security
	}
}
