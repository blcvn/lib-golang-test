...
import (
	...
	"github.com/blcvn/lib-golang-test/consensus/raft3/v3/confchange"
	"github.com/blcvn/lib-golang-test/consensus/raft3/v3/quorum"
	pb "github.com/blcvn/lib-golang-test/consensus/raft3/v3/raftpb"
	"github.com/blcvn/lib-golang-test/consensus/raft3/v3/tracker"
)
...
func (r *raft) hup(t CampaignType) {
	...
	if r.isLearner {
		r.logger.Warningf("%x is learner", r.id)
		return
